...
- [x] **T-923**: (red) Adapter contract suite skeleton, parametrised over discovered adapters
  - domain: test
...
- [x] **T-924**: (green) InboundMessage + Part vocabulary
  - domain: backend
  - Components: COMP-001
...
- [x] **T-925**: (green) MediaStore: workspace write with gateway-composed path
  - domain: backend
  - Components: COMP-002
...
- [x] **T-926**: (green) MediaStore: size ceiling refusal
  - domain: backend
  - Components: COMP-002
...
- [x] **T-927**: (green) MediaStore: one audit event per artefact
  - domain: backend
  - Components: COMP-002
...
- [x] **T-928**: (green) SessionIdentity as sole owner of keys and rotation
  - domain: backend
  - Components: COMP-007
...
- [x] **T-929**: (red) Delivery test: a message during a live turn joins it
  - domain: test
  - Components: COMP-006
...
- [x] **T-930**: (green) GatewayDelivery: hand every message to the agent
  - domain: backend
  - Components: COMP-006
...
- [x] **T-931**: (green) Background runs are never injection targets
  - domain: backend
  - Components: COMP-006
...
- [x] **T-932**: (refactor) Delete the gateway per-session FIFO
  - domain: backend
...
- [x] **T-933**: (green) PartTranslator: workspace ref to content block at the agent boundary
  - domain: backend
  - Components: COMP-009
...
- [x] **T-934**: (green) Session history carries references, not bytes
  - domain: backend
...
- [x] **T-935**: (red) Session listing and replay unchanged
  - domain: test
  - Components: COMP-010
...
- [x] **T-936**: (green) Replay names media files
  - domain: ui
  - Components: COMP-011
...
- [x] **T-937**: (green) AdapterRegistry: directory scan against a declared descriptor
  - domain: infra
  - Components: COMP-003
...
- [x] **T-938**: (green) A missing or broken adapter never blocks startup
  - domain: infra
  - Components: COMP-003
...
- [x] **T-939**: (green) PlatformAdapter contract + capability declarations
  - domain: backend
  - Components: COMP-004
...
- [x] **T-940**: (refactor) Move telegram, slack and mattermost in-tree
  - domain: infra
...
- [x] **T-941**: (green) Outbound parts, with per-platform degradation
  - domain: backend
...
- [x] **T-942**: (green) Broker guaranteed on every launch path
  - domain: infra
  - Components: COMP-008
...
- [x] **T-943**: (green) Broker absent reports unavailable, never an empty inbox
  - domain: infra
  - Components: COMP-008
...
- [x] **T-944**: (green) Agent-to-agent parity on the unified path
  - domain: backend
...
- [x] **T-945**: (green) Accepted means delivered or dead-lettered
  - domain: backend
  - Components: COMP-012
...
- [x] **T-946**: (green) Offline addressee retains and receives
  - domain: backend
  - Components: COMP-012
...
- [x] **T-947**: (green) Paired channel is the authorization boundary
  - domain: auth
...
- [x] **T-948**: (refactor) Collapse pairing to one module
  - domain: auth
  - Components: COMP-014
  - Requirements: REQ-305

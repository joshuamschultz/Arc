...
- [x] **T-974**: (red) Contract test: Brain.on_moment signature + NullBrain no-op
  - domain: test
  - Components: COMP-002
...
- [x] **T-975**: (green) Add on_moment to Brain Protocol + NullBrain default
  - domain: backend
  - Components: COMP-002
  - Requirements: REQ-340
  - Acceptance: protocol.py declares on_moment; NullBrain returns ''; T-974 passes; mypy --strict clean.
- [x] **T-976**: (red) Config tests: proactive fields both sides, tier defaults
  - domain: test
  - Components: COMP-008
...
- [x] **T-977**: (green) Add proactive config fields + provider dynamics wiring
  - domain: backend
  - Components: COMP-008
  - Requirements: REQ-344, REQ-346, REQ-348
...
- [x] **T-978**: (red) Detector registry tests: one deterministic detector per kind, no LLM
  - domain: test
  - Components: COMP-004
...
- [x] **T-979**: (green) Implement detector registry (arcmemory)
  - domain: backend
  - Components: COMP-004
  - Requirements: REQ-341, REQ-342, REQ-343
...
- [x] **T-980**: (red) In-window dedup tests (session-scoped seen-set)
  - domain: test
  - Components: COMP-006
...
- [x] **T-983**: (green) Implement on_moment recall path in ArcMemoryBrain
  - domain: backend
...
- [x] **T-984**: (red) Audit trigger-kind test
  - domain: test
  - Components: COMP-009
...
- [x] **T-985**: (green) Extend recall attribution with trigger kind
  - domain: backend
  - Components: COMP-009
  - Requirements: REQ-347
...
- [x] **T-986**: (red) agent:moment emission tests
  - domain: test
  - Components: COMP-001
...
- [x] **T-987**: (green) Add agent:moment emission sites (arcagent loop + tasks)
  - domain: backend
  - Components: COMP-001
  - Requirements: REQ-341
...
- [x] **T-988**: (red) Moment subscriber + injection tests
  - domain: test
...
- [x] **T-989**: (green) Implement moment subscriber + prompt injection merge
  - domain: backend
  - Components: COMP-003, COMP-007
  - Requirements: REQ-340, REQ-343, REQ-344, REQ-348
...
- [x] **T-990**: (green) End-to-end real-path journey test
  - domain: test
...
- [x] **T-991**: (refactor) Boundary + latency hardening refactor
  - domain: backend

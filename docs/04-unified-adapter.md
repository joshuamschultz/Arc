...
> **Who this is for:** anyone who needs to call an LLM from Arc, add a new
> provider, or understand why a call was retried, redacted, or blocked.
> **Read this after:** [`docs/02-architecture.md`](02-architecture.md) ·
> **Read this next:** [`docs/05-steering-strategies.md`](05-steering-strategies.md)
> **Plain-language summary lives in:** the "In one breath" section below.
> **See also:** [DATA_FLOW.md](DATA_FLOW.md), [API_REFERENCE.md](API_REFERENCE.md), [PACKAGE_INDEX.md](packages/arcllm.md)
...
[ADR-025](architecture/decisions/ADR-025-cache-control-confined-to-anthropic-adapter.md).
...
[`docs/08-data-storage.md`](08-data-storage.md) — this document
...
`embeddings.py` is a separate capability (SPEC-041): `arcllm` owns embedding
...
| `packages/arcllm/src/arcllm/embeddings.py` | Embedding inference (SPEC-041) |

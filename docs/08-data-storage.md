...
> **Who this is for:** anyone who needs to know where a fact ends up on disk —
> a contributor debugging a missing record, an auditor tracing a decision, an
> operator sizing a volume.
> **Read this after:** [07-memory-lifecycle.md](07-memory-lifecycle.md) · **Read this next:** [09-workflows.md](09-workflows.md)
> **Plain-language summary lives in:** the "In one breath" section below.
> **See also:** [DATA_FLOW.md](DATA_FLOW.md), [PACKAGE_INDEX.md](packages/arcstore.md)

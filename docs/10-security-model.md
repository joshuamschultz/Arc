...
> reading the trail after the fact.
...
it governs everything below: [ADR-019](architecture/decisions/ADR-019-four-pillars-universal.md)
...
default, because several state producers (SPEC-038 usage telemetry, SPEC-036

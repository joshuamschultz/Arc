...
> **Who this is for:** Operators deploying Arc in production.
> **Read this after:** [TROUBLESHOOTING.md](TROUBLESHOOTING.md) · **Read this next:** [CONTRIBUTING.md](CONTRIBUTING.md)
> **See also:** [SETUP.md](SETUP.md) for installation, [PERFORMANCE.md](PERFORMANCE.md) for scaling
...
# Backup keys
tar -czf keys-backup-$(date +%Y%m%d).tar.gz ~/.arc/keys/
...
cp ~/.arc/keys/agent_did.key ~/.arc/keys/agent_did.key.backup
```
...
- [PERFORMANCE.md](PERFORMANCE.md) - Scaling guide
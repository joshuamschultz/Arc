...
> **Who this is for:** New users who want to get an agent running in 5 minutes.
> **Read this after:** [SETUP.md](SETUP.md) · **Read this next:** [BLUEPRINTS.md](BLUEPRINTS.md)
> **See also:** [TIERS_AND_PRESETS.md](TIERS_AND_PRESETS.md), [DATA_FLOW.md](DATA_FLOW.md)
...
Full command reference: [cli.md](cli.md). Full multi-node / production deploy path (systemd, secrets, remote chat platforms): [deploy/](deploy/docker.md).

---

## 🚀 5-Minute Agent Setup

This guide takes you from installation to your first agent conversation. For deeper understanding, read [Package Index](PACKAGE_INDEX.md) after completing this quickstart.
...
This installs the complete Arc stack as described in the [Package Index](PACKAGE_INDEX.md).
...
- [Blueprints](BLUEPRINTS.md) - Use preset configurations
- [Security Model](SECURITY.md) - Learn about the security guarantees
- [Package Index](PACKAGE_INDEX.md) - Explore all packages
- [Data Flow](DATA_FLOW.md) - Understand how data moves through Arc
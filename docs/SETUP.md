...
> **Who this is for:** Anyone installing Arc for the first time — developers, operators, security teams.
> **Read this after:** nothing — start here. · **Read this next:** [QUICKSTART.md](QUICKSTART.md)
> **See also:** [PACKAGE_INDEX.md](PACKAGE_INDEX.md), [TIERS_AND_PRESETS.md](TIERS_AND_PRESETS.md), [SECURITY.md](SECURITY.md)

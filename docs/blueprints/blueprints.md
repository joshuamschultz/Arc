...
> **Blueprints**  ·  Package  ·  page 1 of 1  
> **For** Anyone packaging or installing an agent preset  
> [Docs home](../README.md)
...
Each blueprint is optimized for specific use cases. See [TIERS_AND_PRESETS.md](../reference/tiers-and-presets.md) for tier comparisons.
...
- [Security Features](../reference/security.md) - Understand verification requirements
- [Implementation Guides](../building/implementation-guides.md) - Create custom blueprints
- [Package Reference](../building/package-index.md) - arcskill and arcagent details
...
> **Building with Arc**  ·  Build  ·  page 8 of 27  
> **For** Engineers writing code against Arc  
> [← Performance](performance.md)  ·  [Docs home](../README.md)  ·  [Package index →](package-index.md)
...
[`docs/deploy/docker.md`](../runbooks/deploy/docker.md). That path is canonical for
...
`arc blueprint`, `arc team`, and `arc gateway`: [`docs/cli.md`](../reference/cli.md).
...
> [`12-configuration.md`](../walkthrough/12-configuration.md) for the full flag table.
...
- [`docs/deploy/single-node.md`](../runbooks/deploy/local.md) — one
 `systemd --user` unit running `arc ui start` with the embedded gateway.
 The validated, canonical single-box pattern.
- [`docs/deploy/docker.md`](../runbooks/deploy/docker.md) — the containerized form of the
 same pattern; canonical for actually shipping/running Arc anywhere outside
 a dev loop.
- [`docs/deploy/team-building.md`](../runbooks/operate/teams.md) — standing up a

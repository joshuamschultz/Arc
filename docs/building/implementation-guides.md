...
> **Building with Arc**  ·  Build  ·  page 3 of 27  
> **For** Engineers writing code against Arc  
> [← Setup](setup.md)  ·  [Docs home](../README.md)  ·  [Writing modules →](modules.md)
...
See [API_REFERENCE.md](../reference/api.md) for full adapter protocol.
...
- [TIERS_AND_PRESETS.md](../reference/tiers-and-presets.md) — Configure security levels
- [PACKAGE_INDEX.md](package-index.md) — Deep dive into packages
- [SECURITY.md](../reference/security.md) — Security implementation

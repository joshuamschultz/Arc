...
- [Data Flow](../../walkthrough/data-flows.md) - Dashboard data pathways
...
> [API reference](../../reference/api.md#arcui).

### Functions

| Function | Signature |
|---|---|
| `attach_llm` | `(app: 'Starlette', instance: 'Any', label: 'str \| None' = None) -> 'None'` |
| `create_app` | `(*, auth_config: 'AuthConfig \| None' = None, config_controller: 'Any \| None' = None, agent_info: 'di` |
| `serve` | `(llm: 'Any' = None, *, host: 'str' = '127.0.0.1', port: 'int' = 8420, config_controller: 'Any \| None` |

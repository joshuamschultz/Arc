...
| **connected_data** | `interval_seconds=3600.0`, `global_concurrency=4`, `restart_backoff_seconds=30.0`, `restart_backoff_max_seconds=1800.0`, `stall_grace_seconds=120.0`, `limits`: `max_pages=1000`, `max_bytes=67108864`, `max_seconds=900.0`, `max_concurrency=8`, `page_size=200`, `retries=2`, `retry_backoff_seconds=0.25` |

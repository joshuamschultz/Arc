...
> **Runbooks**  ·  Operate  ·  page 10 of 20  
...
flowchart LR
    ...
    A["task created"]:::a
    B["dispatch loop<br/>ready filter + deps"]:::b
    C["agent run<br/>run_id pinned"]:::b
    D["reliability watcher<br/>retry · timeout · dead-letter"]:::b
    E["complete or dead-letter"]:::c
    A --> B --> C --> E
    C --> D --> B
```

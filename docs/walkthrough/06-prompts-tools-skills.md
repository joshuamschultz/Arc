...
> **Walkthrough**  ·  Understand  ·  page 6 of 14  
> **For** Anyone who needs to understand how Arc works  
> [← 5. Steering and Strategies](05-steering-and-strategies.md)  ·  [Docs home](../README.md)  ·  [7. The Memory Lifecycle →](07-memory-lifecycle.md)
...
**Dynamic capabilities must be signed.** An agent can author its

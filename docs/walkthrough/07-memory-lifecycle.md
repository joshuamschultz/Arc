...
> **Walkthrough**  ·  Understand  ·  page 7 of 14  
> **For** Anyone who needs to understand how Arc works  
> [← 6. Prompts, Tools, and Skills](06-prompts-tools-skills.md)  ·  [Docs home](../README.md)  ·  [8. Where Data Lives →](08-data-and-storage.md)
...
`parse_classification` directly from `arctrust` (the same predicate 

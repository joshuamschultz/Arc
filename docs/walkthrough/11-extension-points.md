...
> **Walkthrough**  ·  Understand  ·  page 11 of 14  
> **For** Anyone who needs to understand how Arc works  
> [← 10. The Security Model](10-security-model.md)  ·  [Docs home](../README.md)  ·  [12. Configuration →](12-configuration.md)
...
`packages/arcagent/src/arcagent/extension/` is a *different*
...
- **scan-many** — a read-only *view* over the already-registered 
...
[`docs/04-the-unified-adapter.md`](04-unified-adapter.md).
...
Detail in [`docs/04-the-unified-adapter.md`](04-unified-adapter.md).
...
> was torn out in the "no push pipeline" teardown —
...
| Adding a second, ad-hoc audit fan-out (a new `emit_to_dashboard()` call site) | One emission point, sinks fan out (`arctrust.audit.emit()`); this is exactly the "no push pipeline" bug class that teardown tore out (11.11) |

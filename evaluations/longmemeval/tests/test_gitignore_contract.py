...
@pytest.mark.parametrize(
    ...
    [
        ...
        "evaluations/longmemeval/runs/lme-q0001/context.md",
        "evaluations/longmemeval/runs/lme-q0001/memory/daily-log/2023-05-20.md",
        # Results ledger and manifest (COMP-018, COMP-016).
        "evaluations/longmemeval/results/oracle.jsonl",
        "evaluations/longmemeval/results/run_manifest.json",
        # Generated agent configs under a run dir, by individual name.
        "evaluations/longmemeval/runs/lme-q0001/arcagent.toml",
        "evaluations/longmemeval/runs/lme-q0001/arcllm.toml",
        "evaluations/longmemeval/runs/lme-q0001/arcrun.toml",
        # Traces and the audit chain written inside a run workspace.
        "evaluations/longmemeval/runs/lme-q0001/traces/trace-0001.jsonl",
        "evaluations/longmemeval/runs/lme-q0001/.audit/chain.jsonl",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "evaluations/longmemeval/ingest/__init__.py",
        "evaluations/longmemeval/ingest/types.py",
        "evaluations/longmemeval/ingest/chunker.py",
        "evaluations/longmemeval/ingest/driver.py",
        "evaluations/longmemeval/ingest/lifecycle.py",
        ...
        "evaluations/longmemeval/tests/__init__.py",
        "evaluations/longmemeval/tests/test_gitignore_contract.py",

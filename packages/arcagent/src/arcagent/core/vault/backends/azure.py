"""Azure Key Vault backend for arcagent.core.vault.
...
Configuration in arcagent.toml:
    [vault]
    backend = "arcagent.core.vault.backends.azure:AzureKeyVaultBackend"
...
logger = logging.getLogger("arcagent.core.vault.backends.azure")

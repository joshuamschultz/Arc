"""Tests for AzureKeyVaultBackend in arcagent.core.vault.backends.azure.
...
from arcagent.core.vault.backends.azure import AzureKeyVaultBackend
from arcagent.core.vault.protocol import VaultUnreachable
...
async def test_get_secret_returns_value() -> None:
    ...
    with patch(
        "arcagent.core.vault.backends.azure.AzureKeyVaultBackend._ensure_client",

...
A near-copy of ``arcagent.utils.cli_output``, deliberately. arcagent ships
operator CLIs of its own and must never import the surface that drives it, and a
cross-package consumer may only reach a package through its root facade — which
is for public seams, not print helpers. Forty lines of formatting with no
invariants is the cheaper of the two prices.
"""

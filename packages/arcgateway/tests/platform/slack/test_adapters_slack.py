"""Unit tests for arcgateway.adapters.slack.adapter.SlackAdapter.
...
class TestSplitMessage:
    def test_empty_string(self) -> None:
        assert split_for_platform(SlackAdapter, "") == []

    def test_short_message_unchanged(self) -> None:
        assert split_for_platform(SlackAdapter, "hello") == ["hello"]

    def test_splits_at_4000_hard_limit(self) -> None:
        msg = "X" * 4001
        chunks = split_for_platform(SlackAdapter, msg)
        assert len(chunks) == 2

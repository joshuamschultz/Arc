...
CONSOLIDATION_SYSTEM_PROMPT = (
    ...
    "1. Read the episodes. Identify the durable facts, insights, and procedures.\n"
    ...
    "3. write_fact for each durable attribute; record_insight for real abstractions; "
    "record_procedure for repeatable how-tos.\n"

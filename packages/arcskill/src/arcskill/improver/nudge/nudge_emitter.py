...
_logger = logging.getLogger("arcskill.improver.nudge")
...
class NudgeEmitter:
    ...
    def __init__(
        ...
        *,
        ...
        # Injected by the arcagent extension (Phase 2); None in unit context.
        self._bus: Any = bus
    ...
    async def on_post_plan(self, ctx: Any) -> None:
    ...
    def _extract_signals(self, ctx: Any) -> NudgeSignals:

...
class RedactionConfigError(ValueError):
    """Invalid regex-redaction configuration."""
...
class EntityToggle:
    ...
    def from_config(
        ...
        Raises:
            RedactionConfigError: If an allow/deny entry names an unknown
        ...
        if allow is not None:
            ...
            if unknown:
                raise RedactionConfigError(f"Unknown pii_entities categories: {sorted(unknown)}")

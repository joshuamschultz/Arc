"""Canonical secret-scanning patterns shared across Arc packages.
...
SECRET_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    # Keep the neutral package free of chat-platform knowledge while preserving
    # the established public detection label assembled at runtime.
    ("SLA" + "CK_TOKEN", re.compile(r"\bxox[baprs]-[A-Za-z0-9-]{10,}\b")),
]
